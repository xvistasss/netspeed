  ...
  return (
    <details className="group border border-hairline rounded-lg overflow-hidden bg-canvas">
      <summary className="bg-canvas-soft-2 p-4 cursor-pointer text-xs font-mono text-mute select-none flex justify-between items-center hover:bg-canvas-soft-2/80 transition-colors duration-150">
        ...
        <span className="text-[10px] text-mute group-open:rotate-180 transition-transform duration-150">▼</span>
      </summary>
      <div className="p-5 border-t border-hairline flex flex-col md:flex-row justify-between gap-6 text-xs text-body font-mono">
        <div className="flex flex-col gap-2">
          ...
          <div className="tabular-nums">IP: <span className="text-ink">{clientInfo.ip}</span></div>
        ...
        <div className="flex flex-col gap-2">
          ...
          {selectedServer && selectedServer.id !== 'local-edge' && clientInfo.latitude !== 0 && (
            <div className="tabular-nums">Distance: <span className="text-ink">
          ...
          {selectedServer && selectedServer.id === 'local-edge' && (
            <div className="tabular-nums">Distance: <span className="text-ink">0 km (Local Loopback)</span></div>
          )}
          <div className="tabular-nums">Pre-Ping Latency: <span className="text-ink">
